  ...
  _createClass(Config, [{
    ...
    value: function getFace(faceKey) {
      ...
      if (!ret && faceKey.includes('_')) {
        (function () {
          var charName = faceKey.substr(0, faceKey.indexOf('_'));
          var tmpFaceKey = Object.keys(_this._config.face).find(function (v) {
            return v.startsWith(charName);
          });
          if (tmpFaceKey) {
            ret = Object.assign({}, _this._config.face[tmpFaceKey]);
            ret.filename = false;
            ret.number = -1;
          }
        })();
    ...
    key: 'getSystem',
    value: function getSystem(label) {
      ...
      if (yamlObj.person) {
        ...
        Object.keys(yamlObj.person).forEach(function (name) {
          ...
          Object.keys(person.faces).forEach(function (faceName) {
            ...
            var nameConfig = _this2._config.style.display.name;
            ...
            _this2._config.face[faceKey] = face;
          });
        });
      }
    }
