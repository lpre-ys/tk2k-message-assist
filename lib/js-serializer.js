...
var JsSerializer = function () {
  ...
  _createClass(JsSerializer, [{
    ...
    value: function _extractRight(text, hasFace) {
      var inRight = arguments.length <= 2 || arguments[2] === undefined ? false : arguments[2];
      ...
      if (fullMatch) {
        ...
        var lead = _fullMatch2[1];
        var inner = _fullMatch2[2];
        var trail = _fullMatch2[3];
      ...
      if (!inRight && !text.includes('</right>')) {
        ...
        if (startMatch) {
          ...
          var _lead2 = _startMatch2[1];
          var afterRight = _startMatch2[2];
      ...
      if (inRight) {
        ...
        if (endMatch) {
          ...
          var beforeRight = _endMatch2[1];
          var _trail2 = _endMatch2[2];
