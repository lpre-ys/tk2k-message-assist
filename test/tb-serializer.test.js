  ...
  describe('serialize', () => {
    describe('no decoration', () => {
      it('1 line 1 window', () => {
        ...
        messageBlock.addMessage({line: ['TestMessage']});
      ...
      it('2 line 1 window', () => {
        const messageBlock = new MessageBlock();
        messageBlock.addMessage({line: ['TestMessage', 'TestMessage2']});
        const ret = serializer.serialize([messageBlock]);
      ...
      it('2 window', () => {
        const messageBlock = new MessageBlock();
        messageBlock.addMessage({line: ['TestMessage', 'TestMessage2']});
        messageBlock.addMessage({line: ['TestMessage3']});
        const ret = serializer.serialize([messageBlock]);
...
Text("\\C[4]【テスト２】\\C[0]\\kTestMessage2")`);
    ...
    describe('color', () => {
      it('1 tag', () => {
        const messageBlock = new MessageBlock();
        messageBlock.addMessage({line: ['normal<yellow>yellow</yellow>normal']});
        const ret = serializer.serialize([messageBlock]);
      ...
      it('2 tag', () => {
        const messageBlock = new MessageBlock();
        messageBlock.addMessage({line: ['normal<yellow>yellow<red>red</red></yellow>normal']});
        const ret = serializer.serialize([messageBlock]);
    ...
    describe('control tag', () => {
      it('stop', () => {
        const messageBlock = new MessageBlock();
        messageBlock.addMessage({line: ['stop before<stop></stop>after']});
        const ret = serializer.serialize([messageBlock]);
      ...
      it('wait', () => {
        const messageBlock = new MessageBlock();
        messageBlock.addMessage({line: ['wait before<wait></wait>after']});
        const ret = serializer.serialize([messageBlock]);
      ...
      it('q_wait', () => {
        const messageBlock = new MessageBlock();
        messageBlock.addMessage({line: ['quarter wait before<q_wait></q_wait>after']});
        const ret = serializer.serialize([messageBlock]);
      ...
      it('flash', () => {
        const messageBlock = new MessageBlock();
        messageBlock.addMessage({line: ['normal<flash>flash</flash>normal']});
        const ret = serializer.serialize([messageBlock]);
